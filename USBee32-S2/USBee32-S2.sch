...
Text Notes 890  4030 0    118  ~ 24
USB-A\n
Wire Notes Line
	3705 715  470  715 
Wire Wire Line
	1000 1130 675  1130
Text Notes 815  680  0    93   ~ 19
ESP32-S2 WROOM RF-Module
Text Notes 4805 660  0    118  ~ 24
Pin Headers
$Comp
L ESP32-S2-rescue:AMS1117-3.3-Regulator_Linear U3
U 1 1 6028A484
P 7800 3130
F 0 "U3" H 7800 3372 50  0000 C CNN
F 1 "AMS1117-3.3" H 7800 3281 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-223-3_TabPin2" H 7800 3330 50  0001 C CNN
F 3 "http://www.advanced-monolithic.com/pdf/ds1117.pdf" H 7900 2880 50  0001 C CNN
	1    7800 3130
	1    0    0    -1  
$EndComp
Text Label 1295 4445 0    50   ~ 0
VBUSA
Text Label 6710 3130 0    50   ~ 0
VI
$Comp
L ESP32-S2-rescue:C-Device C7
U 1 1 60322108
P 7295 3355
F 0 "C7" H 7070 3305 50  0000 L CNN
F 1 "0.1uF" H 6995 3395 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 7333 3205 50  0001 C CNN
F 3 "~" H 7295 3355 50  0001 C CNN
	1    7295 3355
	-1   0    0    1   
$EndComp
Wire Wire Line
	7800 3430 7800 3595
Connection ~ 7800 3595
Wire Wire Line
	8100 3130 8180 3130
$Comp
...
U 1 1 604487CE
P 7800 3595
F 0 "#PWR022" H 7800 3345 50  0001 C CNN
F 1 "GND" H 7805 3422 50  0000 C CNN
F 2 "" H 7800 3595 50  0001 C CNN
F 3 "" H 7800 3595 50  0001 C CNN
	1    7800 3595
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 60463D39
P 8340 3130
F 0 "#PWR024" H 8340 2980 50  0001 C CNN
F 1 "+3.3V" H 8355 3303 50  0000 C CNN
F 2 "" H 8340 3130 50  0001 C CNN
F 3 "" H 8340 3130 50  0001 C CNN
	1    8340 3130
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 6033F05F
P 8995 3355
F 0 "R12" H 9055 3390 50  0000 L CNN
F 1 "1k" H 9055 3290 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 8925 3355 50  0001 C CNN
F 3 "~" H 8995 3355 50  0001 C CNN
	1    8995 3355
	1    0    0    -1  
$EndComp
$Comp
...
Wire Wire Line
	7295 3205 7295 3130
Connection ~ 7295 3130
Wire Wire Line
	8180 3220 8180 3130
Connection ~ 8180 3130
Wire Wire Line
	8180 3130 8340 3130
Connection ~ 8340 3130
$Comp
L ESP32-S2-rescue:LED-Device D2
U 1 1 602D9272
P 8820 3130
F 0 "D2" H 8859 3012 50  0000 R CNN
F 1 "LED" H 8885 3225 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric_Castellated" H 8820 3130 50  0001 C CNN
F 3 "~" H 8820 3130 50  0001 C CNN
	1    8820 3130
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 6084EB48
P 8560 3355
F 0 "C10" H 8335 3305 50  0000 L CNN
F 1 "0.1uF" H 8260 3395 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 8598 3205 50  0001 C CNN
F 3 "~" H 8560 3355 50  0001 C CNN
	1    8560 3355
	-1   0    0    1   
$EndComp
Wire Wire Line
	8560 3505 8560 3595
Connection ~ 8560 3595
Wire Wire Line
	8560 3595 8995 3595
Wire Wire Line
	8560 3205 8560 3130
Connection ~ 8560 3130
Wire Wire Line
	8560 3130 8670 3130
$Comp
...
U 1 1 605779A1
P 6905 3360
F 0 "C6" H 6680 3310 50  0000 L CNN
F 1 "10 uF" H 6605 3400 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 6943 3210 50  0001 C CNN
F 3 "~" H 6905 3360 50  0001 C CNN
	1    6905 3360
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 60577F9E
P 8180 3370
F 0 "C8" H 7955 3320 50  0000 L CNN
F 1 "22 uF" H 7880 3410 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 8218 3220 50  0001 C CNN
F 3 "~" H 8180 3370 50  0001 C CNN
	1    8180 3370
	-1   0    0    1   
$EndComp
...
Wire Wire Line
	6675 1600 7375 1600
Text Label 6675 1600 0    50   ~ 0
VBUSA
Wire Wire Line
	7375 1345 7445 1345
Connection ~ 7375 1345
Wire Wire Line
	7375 1345 7375 1600
Text Label 6670 1345 0    50   ~ 0
VBUSC
Text Label 7785 1345 2    50   ~ 0
VI
Wire Wire Line
	7645 1345 7785 1345
$Comp
...
U 1 1 6047A0CA
P 7545 1345
F 0 "F1" V 7445 1345 50  0000 C CNN
F 1 "Polyfuse_Small" V 7635 1470 50  0000 C CNN
F 2 "Fuse:Fuse_1206_3216Metric" H 7595 1145 50  0001 L CNN
...
Wire Wire Line
	6875 1345 6670 1345
Text Notes 5375 4045 0    118  ~ 24
LiPo Battery Charging Section\n
Wire Notes Line
	9210 710  9210 1705
Wire Notes Line
	6685 1730 6685 1735
...
Text Label 9660 5645 2    50   ~ 0
GPIO_17
Text Label 9660 5745 2    50   ~ 0
VI
$Comp
L ESP32-S2-rescue:GND-power #PWR026
U 1 1 60C5B2E2
P 10755 6035
F 0 "#PWR026" H 10755 5785 50  0001 C CNN
F 1 "GND" H 10760 5862 50  0000 C CNN
F 2 "" H 10755 6035 50  0001 C CNN
F 3 "" H 10755 6035 50  0001 C CNN
	1    10755 6035
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 60CA2577
P 10755 5885
F 0 "R13" H 10814 5931 50  0000 L CNN
F 1 "1k" H 10814 5840 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" H 10755 5885 50  0001 C CNN
F 3 "~" H 10755 5885 50  0001 C CNN
	1    10755 5885
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 60956142
P 7025 1345
F 0 "D1" H 7025 1128 50  0000 C CNN
F 1 "1N5819" H 7025 1219 50  0000 C CNN
F 2 "Diode_SMD:D_1206_3216Metric" H 7025 1170 50  0001 C CNN
F 3 "http://www.vishay.com/docs/88525/1n5817.pdf" H 7025 1345 50  0001 C CNN
	1    7025 1345
	-1   0    0    1   
$EndComp
Wire Wire Line
	7175 1345 7375 1345
Text Notes 9285 3300 0    118  ~ 24
ESD Protection Chip
...
U 1 1 60A01739
P 9610 3875
F 0 "U5" H 10210 4140 50  0000 C CNN
...
Wire Notes Line
	9220 945  9220 940 
Text Notes 9835 5090 0    118  ~ 24
Neopixel
$Comp
L ESP32-S2-rescue:R-Device R14
U 1 1 60A58974
P 6955 5025
F 0 "R14" H 7025 5071 50  0000 L CNN
...
U 1 1 60ADA7D5
P 5405 4900
F 0 "#PWR017" H 5405 4750 50  0001 C CNN
F 1 "+BATT" H 5420 5073 50  0000 C CNN
F 2 "" H 5405 4900 50  0001 C CNN
F 3 "" H 5405 4900 50  0001 C CNN
	1    5405 4900
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 60B24C40
P 5605 4890
F 0 "#PWR018" H 5605 4640 50  0001 C CNN
F 1 "GND" H 5610 4717 50  0000 C CNN
F 2 "" H 5605 4890 50  0001 C CNN
F 3 "" H 5605 4890 50  0001 C CNN
	1    5605 4890
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 60DACAED
P 8135 4335
F 0 "#PWR023" H 8135 4185 50  0001 C CNN
F 1 "+BATT" H 8150 4508 50  0000 C CNN
F 2 "" H 8135 4335 50  0001 C CNN
F 3 "" H 8135 4335 50  0001 C CNN
	1    8135 4335
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 60F7770E
P 5405 4585
F 0 "J4" V 5394 4355 50  0000 R CNN
F 1 "B2B-PH-SM4-TB(LF)(SN)" V 5303 4355 50  0000 R CNN
F 2 "B2B-PH-SM4-TB:JST_B2B-PH-SM4-TB(LF)(SN)" H 5405 4585 50  0001 L BNN
F 3 "" H 5405 4585 50  0001 L BNN
F 4 "JST" H 5405 4585 50  0001 L BNN "MANUFACTURER"
	1    5405 4585
	0    -1   -1   0   
$EndComp
...
D1-
$Comp
L ESP32-S2-rescue:+3.3V-power #PWR029
U 1 1 60F17964
P 6150 2615
F 0 "#PWR029" H 6150 2465 50  0001 C CNN
F 1 "+3.3V" V 6145 2830 50  0000 C CNN
F 2 "" H 6150 2615 50  0001 C CNN
F 3 "" H 6150 2615 50  0001 C CNN
	1    6150 2615
	0    1    1    0   
$EndComp
Wire Wire Line
	6150 2615 5875 2615
$Comp
L ESP32-S2-rescue:+BATT-power #PWR030
U 1 1 618A4651
P 9030 1850
F 0 "#PWR030" H 9030 1700 50  0001 C CNN
F 1 "+BATT" H 9045 2023 50  0000 C CNN
F 2 "" H 9030 1850 50  0001 C CNN
F 3 "" H 9030 1850 50  0001 C CNN
	1    9030 1850
	1    0    0    -1  
$EndComp
$Comp
L WS2812B-2020:WS2812B-2020 LED1
U 1 1 619370D4
P 9755 5645
F 0 "LED1" H 10255 5910 50  0000 C CNN
F 1 "WS2812B-2020" H 10255 5819 50  0000 C CNN
F 2 "WS2812B-2020:WS2812B2020" H 10605 5745 50  0001 L CNN
F 3 "https://www.alldatasheet.com/datasheet-pdf/pdf/1134522/WORLDSEMI/WS2812B-2020.html" H 10605 5645 50  0001 L CNN
F 4 "LED; SMD; 2020; RGB; 2x2x0.84mm; 3.75.3V; Lens: transparent; 2kHz" H 10605 5545 50  0001 L CNN "Description"
F 5 "0.84" H 10605 5445 50  0001 L CNN "Height"
F 6 "Worldsemi" H 10605 5345 50  0001 L CNN "Manufacturer_Name"
F 7 "WS2812B-2020" H 10605 5245 50  0001 L CNN "Manufacturer_Part_Number"
F 8 "" H 10605 5145 50  0001 L CNN "Mouser Part Number"
F 9 "" H 10605 5045 50  0001 L CNN "Mouser Price/Stock"
F 10 "" H 10605 4945 50  0001 L CNN "Arrow Part Number"
F 11 "" H 10605 4845 50  0001 L CNN "Arrow Price/Stock"
	1    9755 5645
	1    0    0    -1  
$EndComp
Wire Wire Line
	10755 5745 10755 5785
Wire Wire Line
	10755 5985 10755 6035
Wire Wire Line
	10755 5645 10835 5645
$Comp
L ESP32-S2-rescue:GND-power #PWR031
U 1 1 6199E242
P 10835 5645
F 0 "#PWR031" H 10835 5395 50  0001 C CNN
F 1 "GND" H 10840 5472 50  0000 C CNN
F 2 "" H 10835 5645 50  0001 C CNN
F 3 "" H 10835 5645 50  0001 C CNN
	1    10835 5645
	0    -1   -1   0   
$EndComp
Wire Wire Line
	9660 5745 9755 5745
Text Notes 8045 5635 0    50   ~ 0
STAT: LED shows charge \nstatus indication \nON - Charge complete state\nOFF - Charging state
Wire Wire Line
	7950 4815 8320 4815
Wire Wire Line
	8135 4615 8135 4885
Connection ~ 8135 4615
$Comp
L DMP2305U-7:DMP2305U-7 U6
U 1 1 61AD6617
P 8270 1850
F 0 "U6" H 8270 2220 50  0000 C CNN
F 1 "DMP2305U-7" H 8270 2129 50  0000 C CNN
F 2 "DMP2305U-7:SOT103P240X110-3N" H 8270 1850 50  0001 L BNN
F 3 "" H 8270 1850 50  0001 L BNN
F 4 "DIODES INC." H 8270 1850 50  0001 L BNN "SUPPLIER"
F 5 "SOT-23-3" H 8270 1850 50  0001 L BNN "PACKAGE"
F 6 "23T5607" H 8270 1850 50  0001 L BNN "OC_NEWARK"
F 7 "1858668" H 8270 1850 50  0001 L BNN "OC_FARNELL"
F 8 "DMP2305U-7" H 8270 1850 50  0001 L BNN "MPN"
	1    8270 1850
	1    0    0    -1  
$EndComp
Wire Wire Line
...
USBee32-S2
Text Notes 4980 5885 0    118  ~ 24
Switches\n
Text Notes 575  5890 0    118  ~ 24
Pull-Up Pins
