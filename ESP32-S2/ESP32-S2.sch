...
U 1 1 6010A754
P 4330 7415
F 0 "#PWR09" H 4330 7165 50  0001 C CNN
...
U 1 1 6010BC5F
P 5430 7430
F 0 "#PWR015" H 5430 7180 50  0001 C CNN
...
U 1 1 60107D6F
P 10085 2695
F 0 "#PWR026" H 10085 2445 50  0001 C CNN
...
U 1 1 600B09CA
P 4065 3245
F 0 "#PWR08" H 4065 2995 50  0001 C CNN
...
U 1 1 600C20A7
P 10420 1935
F 0 "U4" H 10420 1885 50  0000 C CNN
...
U 1 1 60579A17
P 4965 1050
F 0 "#PWR013" H 4965 800 50  0001 C CNN
...
U 1 1 602B0D1F
P 5910 6245
F 0 "#PWR019" H 5910 6095 50  0001 C CNN
...
U 1 1 602AFFC8
P 4810 6260
F 0 "#PWR012" H 4810 6110 50  0001 C CNN
...
U 1 1 604487CE
P 7750 3090
F 0 "#PWR021" H 7750 2840 50  0001 C CNN
...
U 1 1 60463D39
P 8290 2625
F 0 "#PWR023" H 8290 2475 50  0001 C CNN
...
U 1 1 6084EB48
P 8510 2850
F 0 "C9" H 8285 2800 50  0000 L CNN
...
U 1 1 60C81F04
P 10420 985
F 0 "#PWR027" H 10420 835 50  0001 C CNN
...
U 1 1 60DF3BEA
P 9380 2280
F 0 "C10" H 9400 2375 50  0000 L CNN
...
U 1 1 60E56461
P 3835 1875
F 0 "#PWR06" H 3835 1625 50  0001 C CNN
...
U 1 1 6111F61D
P 5875 1015
F 0 "#PWR018" H 5875 765 50  0001 C CNN
...
F 1 "Inolux_IN-PI554FCH" H 10424 5640 50  0000 L CNN
F 2 "LED_SMD:LED_Inolux_IN-PI554FCH_PLCC4_5.0x5.0mm_P3.2mm" H 10130 5385 50  0001 L TNN
F 3 "http://www.inolux-corp.com/datasheet/SMDLED/Addressable%20LED/IN-PI554FCH.pdf" H 10180 5310 50  0001 L TNN
	1    10080 5685
	1    0    0    -1  
$EndComp
...
U 1 1 60C5B2E2
P 10080 6055
F 0 "#PWR025" H 10080 5805 50  0001 C CNN
...
$EndComp
Wire Wire Line
	10080 5985 10080 6045
$Comp
L Device:C_Small C11
U 1 1 60C72A58
P 9690 5890
F 0 "C11" H 9782 5936 50  0000 L CNN
F 1 "0.1uF" H 9782 5845 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 9690 5890 50  0001 C CNN
F 3 "~" H 9690 5890 50  0001 C CNN
	1    9690 5890
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	9615 5685 9690 5685
Connection ~ 9690 5685
Wire Wire Line
	9690 5685 9780 5685
Wire Wire Line
	9690 5990 9690 6045
Wire Wire Line
	9690 6045 10080 6045
Connection ~ 10080 6045
Wire Wire Line
	10080 6045 10080 6055
$Comp
...
U 1 1 60A14DD4
P 9415 4095
F 0 "#PWR024" H 9415 3845 50  0001 C CNN
...
U 1 1 60A59496
P 8135 5035
F 0 "C13" H 8250 5081 50  0000 L CNN
...
U 1 1 60A5C71F
P 7550 5325
F 0 "#PWR020" H 7550 5075 50  0001 C CNN
...
U 1 1 60A9405E
P 4675 5275
F 0 "#PWR011" H 4675 5025 50  0001 C CNN
...
U 1 1 60ADA7D5
P 5435 5205
F 0 "#PWR016" H 5435 5055 50  0001 C CNN
...
U 1 1 60B24C40
P 5635 5195
F 0 "#PWR017" H 5635 4945 50  0001 C CNN
...
U 1 1 60DACAED
P 8125 4335
F 0 "#PWR022" H 8125 4185 50  0001 C CNN
...
U 1 1 60E23FFD
P 4675 4350
F 0 "#PWR010" H 4675 4200 50  0001 C CNN
